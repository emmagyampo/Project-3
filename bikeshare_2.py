...
def get_filters():
    ...
    # get user input for month (all, january, february, ... , june), a prompt is generated if input is not in the list  
    ...
    # get user input for day of week (all, monday, tuesday, ... sunday), a prompt is generated if input is not in the list    
